---
title: "鈴木愛理 ll:Bias by us:ll 線上抽獎介紹以及選擇"
date: 2026-08-12T00:40:10+08:00
lastmod: 2026-09-10T00:08:00+08:00
draft: false
...
> `2026/09/09` 更新：目前官方已全數公開現場拍攝照片款式，圖片皆已更新！

> `2026/09/10` 更新：補上[自己抽到的東西](#寫在後面跟一些碎念)

[鈴木愛理 LIVE 2026 ll:Bias by us:ll 開催記念ラッフルくじ](https://raffle-kuji.jp/lotteries/1388)（ll:Bias by us:ll紀念線上抽獎），有點像是一番賞，把它當作是線上的一番賞去抽就對了。
...
7. 儲值完成後會顯示你的coin有多少
8. 滑到最下方點選抽獎`くじを引く`
9. 開始抽獎，一抽一抽玩。最後會出現抽選結果，還有可以抽的W賞是哪個（QAQ沒有C賞
...
這次live的圖片出來了，更喜歡live版本的各種圖片，可愛超可愛。

{{< figure src="F_06.png" width="350px" class="center" alt="F_06徽章" >}}

我目前是10抽，戰利品如圖，沒有C賞立牌難過QAQ。
可能後面最多再補5抽吧，應該不會再繼續抽了🥲。
如果有抽的話再把圖片補上新的補上。

{{< carousel images="my_raffle_1.png|my_raffle_2.png|my_raffle_3.png" thumbs="true" >}}
